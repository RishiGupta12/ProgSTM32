...
public final class UARTtest7 {
	...
	protected void begin() throws SerialComException {
		...
		try {
			...
			System.out.println("----------- Test 71 SYSTEM RESET -----------");
			try {
				dev.triggerSystemReset();
			} catch (Exception e) {
				e.printStackTrace();
			}
			System.out.println("----------- Test 71 SYSTEM RESET DONE-------");
